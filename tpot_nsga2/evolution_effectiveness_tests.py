...
if __name__ == "__main__":
    ...
    parser.add_argument("--pop_random_sampling", type=int, default=100, help="Population size for the random sampling")
    parser.add_argument("--pop", type=int, default=20, help="Population size for TPOT")
    parser.add_argument("--gen", type=int, default=10, help="Number of generations for the random sampling")
    ...
    for idx_run in range(args.runstart, args.runend):
        ...
        pipeline_optimizer = get_optimizer(args.classification, gens=1, pop_size=args.pop_random_sampling,
