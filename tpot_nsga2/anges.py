import os
os.chdir('/home/matsumoton/common/git/tpot_benchmarking')
print(os.getcwd())
...
save_directory = "/home/matsumoton/common/anges/baseline_dynamic_gen100"
for run_id in range(11,50):
        ...
        tpot = TPOTClassifier(verbosity=2, population_size=100, offspring_size=50, generations=100, track_fitnesses=True,
                track_generations=True, resource_logging=True, test_x = X_test, test_y = y_test, scoring="balanced_accuracy",cv=10, dynamic_rates = True) 
